...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到日曆圖示 ![draw](../common/dde_calendar.svg) ，單擊執行。
...
- 在任務欄右鍵單擊 ![draw](../common/dde_calendar.svg)，選擇 **全部關閉**來關閉日曆。
- 在日曆介面單擊 ![icon_menu](../common/icon_menu.svg)，選擇 **離開** 來關閉日曆。
...
- 在月檢視、周檢視中，週六週日的日期顯示會區別於週一至週五。

> ![notes](../common/notes.svg) 說明： 系統預設一週起始日為星期一，您可以在**控制中心** > **時間日期** > **格式設定** 中修改一週顯示順序。
...
>![tips](../common/tips.svg) 竅門：你也可以單擊選單欄上的 ![add](../common/+.svg) 按鈕建立日程。
   ...
   > ![notess](../common/notes.svg) 說明：只有設定了 **重複** 功能，**結束重複** 才會出現。

4. 單擊 **儲存**，建立日程。

   > ![notes](../common/notes.svg) 說明：支援將日程標籤拖曳到指定的日期或時間上。


### 編輯日程

1. 在月、周或者日檢視中，滑鼠右鍵單擊某一個已建立日程的日期。
2. 選擇 **編輯**，彈出 **編輯日程** 視窗。
3. 設定編輯日程的相關屬性。 
4. 單擊 **儲存**。 
...
在建立日程或編輯日程時，設定 **開始時間**、**結束時間**，可以設定全天或多個持續的全天日程。
...
在主選單中，您可以切換窗口主題、查看說明手冊，了解日曆的更多訊息。
