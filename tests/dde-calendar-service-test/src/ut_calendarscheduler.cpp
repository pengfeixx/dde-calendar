...
*/
#include "ut_calendarscheduler.h"
...
//初始化数据库表
TEST_F(ut_calendarscheduler, dbOparetion)
{
...
TEST_F(ut_calendarscheduler, QueryJobsWithLimit)
{
    const QString jobs = "[{\"Date\":\"2020-12-16\",\"Jobs\":"
                         "[{\"AllDay\":true,\"Description\":\"\",\"End\":\"2020-12-17T23:59:00+08:00\","
                         "\"ID\":3,\"Ignore\":[],\"RRule\":\"FREQ=DAILY;BYDAY=MO,TU,WE,TH,FR;COUNT=2\","
...
TEST_F(ut_calendarscheduler, QueryJobsWithRule)
{
    const QString jobs = "[{\"Date\":\"2020-12-16\",\"Jobs\":"
                         "[{\"AllDay\":true,\"Description\":\"\",\"End\":\"2020-12-17T23:59:00+08:00\","
                         "\"ID\":3,\"Ignore\":[],\"RRule\":\"FREQ=DAILY;BYDAY=MO,TU,WE,TH,FR;COUNT=2\","
