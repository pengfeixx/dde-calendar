...
void ut_CWeekDayBackgroundItem::TearDown()
{
    delete m_weekItem;
    m_weekItem = nullptr;
}
...
//showFocus
TEST_F(ut_CWeekDayBackgroundItem, showFocus)
{
...
//hasNextSubItem
TEST_F(ut_CWeekDayBackgroundItem, hasNextSubItem)
{
    bool hasNextSub;
...
//drawDividingLine
TEST_F(ut_CWeekDayBackgroundItem, drawDividingLine)
{
