...
TEST_F(ut_graphicsview, setTheMe)
{
    int type = 0;
...
TEST_F(ut_graphicsview, MeetCreationConditions)
{
...
TEST_F(ut_graphicsview, setRange)
{
    int w = 20;
    int h = 20;
...
TEST_F(ut_graphicsview, MScheduleTimeThan)
{
...
TEST_F(ut_graphicsview, upDateInfoShow)
{
...
TEST_F(ut_graphicsview, IsEqualtime)
{
    QString begin = "2020-12-01 12:24:36";
    QDateTime begindate = QDateTime::fromString(begin, "yyyy-MM-dd hh:mm:ss");
    QString end = "2020-12-21 12:24:36";
...
TEST_F(ut_graphicsview, JudgeIsCreate)
{
    QPointF pos(20, 20);
...
TEST_F(ut_graphicsview, getDragScheduleInfoBeginTime)
{
    QString begin = "2020-12-01 12:24:36";
    QDateTime begindate = QDateTime::fromString(begin, "yyyy-MM-dd hh:mm:ss");
...
TEST_F(ut_graphicsview, getDragScheduleInfoEndTime)
{
    QString end = "2020-12-21 12:24:36";
    QDateTime enddate = QDateTime::fromString(end, "yyyy-MM-dd hh:mm:ss");
