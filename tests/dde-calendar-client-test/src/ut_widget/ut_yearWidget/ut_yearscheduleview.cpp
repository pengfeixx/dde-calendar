...
*/
#include "ut_yearscheduleview.h"
#include "../third-party_stub/stub.h"
#include "constants.h"
#include <QDebug>

ut_yearscheduleview::ut_yearscheduleview()
{
}
...
QVector<ScheduleDataInfo> ut_yearscheduleview::getScheduleDataInfo()
{
...
QVector<ScheduleDataInfo> ut_yearscheduleview::getScheduleDateAndTitle()
{
    QVector<ScheduleDataInfo> scheduleDate {};
...
bool YScheduleDateThan(const ScheduleDataInfo &s1, const ScheduleDataInfo &s2);
TEST_F(ut_yearscheduleview, yschesuledatethan)
{
...
bool YScheduleDaysThan(const ScheduleDataInfo &s1, const ScheduleDataInfo &s2);
TEST_F(ut_yearscheduleview, yscheduleDaysThan)
{
...
TEST_F(ut_yearscheduleview, setDate)
{
...
TEST_F(ut_yearscheduleview, showWindow)
{
...
TEST_F(ut_yearscheduleview, setTheMe)
{
    int type = 1;
...
TEST_F(ut_yearscheduleview, getCurrentDate)
{
...
TEST_F(ut_yearscheduleview, setOutData)
{
    QVector<ScheduleDataInfo> scheduleInfo = getScheduleDataInfo();
