...
TEST_F(ut_schedulectrldlg, setTheMe)
{
...
TEST_F(ut_schedulectrldlg, addPushButton)
{
...
TEST_F(ut_schedulectrldlg, addsuggestButton)
{
...
TEST_F(ut_schedulectrldlg, addWaringButton)
{
    mScheduleCtrlDlg->addsuggestButton("schedule", true);
    mScheduleCtrlDlg->addsuggestButton("schedule", false);
}
...
TEST_F(ut_schedulectrldlg, clickButton)
{
